  ...
  max_angular_velocity_(1.0), prev_angular_error_(0.0), prev_linear_error_(0.0)
{
  ...
  cmd_pub_ = create_publisher<geometry_msgs::msg::Twist>("/diff_drive_controller/cmd_vel_unstamped", 10);
...
void PDMotionPlanner::controlLoop()
{
  ...
  // Calculate the PD control command
